...
if kamera1_of_2 == 1: 
    ...
    if kamera1_of_2 == 1:
        ...
        gevecht(player_health, player_defense,player_attack,'Zombie',zombie_attack,zombie_defense,zombie_health)
        if player_health<0:
...
if buf == 1:
    player_defense+=1
    print(f'In deze kamer vond je een verdedigingsdrankje.Je krijg +1 defensie. Nu je hebt {player_defense}Df ')
    time.sleep(1)
