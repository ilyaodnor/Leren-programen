...
a = int(input('Kies 0: altijd; 1: vaak; 2: regelmatig; 3: soms; 4: nooit'))
print(COMPETENTIE_STELLING_2)
b = int(input('Kies 0: altijd; 1: vaak; 2: regelmatig; 3: soms; 4: nooit'))
print(COMPETENTIE_STELLING_3)
c = int(input('Kies 0: altijd; 1: vaak; 2: regelmatig; 3: soms; 4: nooit'))
print(COMPETENTIE_STELLING_4)
d = int(input('Kies 0: altijd; 1: vaak; 2: regelmatig; 3: soms; 4: nooit'))
print(COMPETENTIE_STELLING_5)
e = int(input('Kies 0: altijd; 1: vaak; 2: regelmatig; 3: soms; 4: nooit'))
print(COMPETENTIE_STELLING_6)
f = int(input('Kies 0: altijd; 1: vaak; 2: regelmatig; 3: soms; 4: nooit'))
print(COMPETENTIE_STELLING_7)
g = int(input('Kies 0: altijd; 1: vaak; 2: regelmatig; 3: soms; 4: nooit'))

gemmiddelde  = (a+b+c+d+e+f+g)/7
