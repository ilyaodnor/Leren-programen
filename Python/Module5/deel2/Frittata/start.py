...
print(f'{str_amount_fraction(milk)} {str_units(milk,TXT_MILK)}')
print(f'{str_amount_fraction(salt)} {str_units(salt,TXT_SALT)}')
print(f'{str_amount_fraction(pepper)} {str_units(pepper,TXT_PEPPER)}')
print(f'{str_amount_fraction(oil)} {str_units(oil,TXT_OIL)}')
...
print(f'{str_amount_fraction(spinach)} {str_units(spinach,TXT_SPINACH)}')
print(f'{str_amount_fraction(cheese)} {str_units(cheese,TXT_CHEESE)}')
